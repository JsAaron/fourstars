	...
	<view class="l-page">
		<view class="banner-container">
			<view class="container-div">
				<view class="banner-item">
					<view class="flex-column">
						...
						<view class="im-title-fu">
							<text>提供组织架构管理、单点登录、消息推送等API，满足企业个性化的开发需求</text>
						</view>
				...
				<view class="banner-item">
					<image src="/static/workportal/banner-right.png" mode="widthFix" style="width: 650px;"></image>
				</view>
			</view>
		</view>
		<view class="container-div">
			<view class="flex-space-around container-item">
				<view class="item-sty">
					<image src="/static/workportal/img1.png" mode="widthFix" style="width: 700px;"></image>
				</view>
				<view class="item-sty flex-column flex-center">
					<view class="item-padding">
						...
						<view class="item-title-fu">
							<text>将内部已有的各功能模块以应用的方式接入，同意收纳在工作台，为企业提供丰富的办公应用。</text>
						</view>
					</view>
				</view>
			</view>
		...
		<view class="container-bg">
			<view class="container-div">
				<view class="flex-space-around container-item">
					...
					<view class="item-sty">
						<image src="/static/workportal/img2.png" mode="widthFix" style="width: 739px;"></image>
					</view>
				</view>
			</view>
		</view>
